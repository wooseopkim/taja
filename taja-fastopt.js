...
/** @constructor */
function $c_Lcom_linterpreteur_taja_Taja$() {
  $c_O.call(this);
  this.initials$1 = null;
  this.middles$1 = null;
  this.com$linterpreteur$taja$Taja$$finals$1 = null;
  this.consonants$1 = null;
  this.vowels$1 = null;
  this.first$1 = 0;
  this.last$1 = 0;
  this.keystrokes$1 = null;
  this.combinations$1 = null
}
$c_Lcom_linterpreteur_taja_Taja$.prototype = new $h_O();
$c_Lcom_linterpreteur_taja_Taja$.prototype.constructor = $c_Lcom_linterpreteur_taja_Taja$;
/** @constructor */
function $h_Lcom_linterpreteur_taja_Taja$() {
  /*<skip>*/
}
$h_Lcom_linterpreteur_taja_Taja$.prototype = $c_Lcom_linterpreteur_taja_Taja$.prototype;
$c_Lcom_linterpreteur_taja_Taja$.prototype.isVowel__s_Option__Z = (function($char) {
  if ($is_s_Some($char)) {
    var x2 = $as_s_Some($char);
    var c = x2.x$2;
    if ((c === null)) {
      var c$1 = 0
    } else {
      var this$2 = $as_jl_Character(c);
      var c$1 = this$2.value$1
    };
    return this.vowels$1.contains__O__Z(new $c_jl_Character().init___C(c$1))
  } else {
    var x = $m_s_None$();
    if ((x === $char)) {
      return false
    } else {
      throw new $c_s_MatchError().init___O($char)
    }
  }
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.merge__p1__sc_Seq__T = (function(chars) {
  var this$1 = this.combinations$1;
  var key = chars.mkString__T();
...
$c_Lcom_linterpreteur_taja_Taja$.prototype.init___ = (function() {
  $n_Lcom_linterpreteur_taja_Taja$ = this;
  this.initials$1 = $m_s_Array$().apply__C__sc_Seq__AC(12593, new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_jl_Character().init___C(12594), new $c_jl_Character().init___C(12596), new $c_jl_Character().init___C(12599), new $c_jl_Character().init___C(12600), new $c_jl_Character().init___C(12601), new $c_jl_Character().init___C(12609), new $c_jl_Character().init___C(12610), new $c_jl_Character().init___C(12611), new $c_jl_Character().init___C(12613), new $c_jl_Character().init___C(12614), new $c_jl_Character().init___C(12615), new $c_jl_Character().init___C(12616), new $c_jl_Character().init___C(12617), new $c_jl_Character().init___C(12618), new $c_jl_Character().init___C(12619), new $c_jl_Character().init___C(12620), new $c_jl_Character().init___C(12621), new $c_jl_Character().init___C(12622)]));
  this.middles$1 = $m_s_Array$().apply__C__sc_Seq__AC(12623, new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_jl_Character().init___C(12624), new $c_jl_Character().init___C(12625), new $c_jl_Character().init___C(12626), new $c_jl_Character().init___C(12627), new $c_jl_Character().init___C(12628), new $c_jl_Character().init___C(12629), new $c_jl_Character().init___C(12630), new $c_jl_Character().init___C(12631), new $c_jl_Character().init___C(12632), new $c_jl_Character().init___C(12633), new $c_jl_Character().init___C(12634), new $c_jl_Character().init___C(12635), new $c_jl_Character().init___C(12636), new $c_jl_Character().init___C(12637), new $c_jl_Character().init___C(12638), new $c_jl_Character().init___C(12639), new $c_jl_Character().init___C(12640), new $c_jl_Character().init___C(12641), new $c_jl_Character().init___C(12642), new $c_jl_Character().init___C(12643)]));
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([$m_s_None$()]);
  var len = $uI(xs.array$6.length);
  var array = $newArrayObject($d_s_None$.getArrayOf(), [len]);
  var elem$1 = 0;
  elem$1 = 0;
  var this$80 = new $c_sc_IndexedSeqLike$Elements().init___sc_IndexedSeqLike__I__I(xs, 0, $uI(xs.array$6.length));
  while (this$80.hasNext__Z()) {
    var arg1 = this$80.next__O();
    array.u[elem$1] = arg1;
    elem$1 = ((1 + elem$1) | 0)
  };
  var xs$1 = $m_s_Array$().apply__C__sc_Seq__AC(12593, new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_jl_Character().init___C(12594), new $c_jl_Character().init___C(12595), new $c_jl_Character().init___C(12596), new $c_jl_Character().init___C(12597), new $c_jl_Character().init___C(12598), new $c_jl_Character().init___C(12599), new $c_jl_Character().init___C(12601), new $c_jl_Character().init___C(12602), new $c_jl_Character().init___C(12603), new $c_jl_Character().init___C(12604), new $c_jl_Character().init___C(12605), new $c_jl_Character().init___C(12606), new $c_jl_Character().init___C(12607), new $c_jl_Character().init___C(12608), new $c_jl_Character().init___C(12609), new $c_jl_Character().init___C(12610), new $c_jl_Character().init___C(12612), new $c_jl_Character().init___C(12613), new $c_jl_Character().init___C(12614), new $c_jl_Character().init___C(12615), new $c_jl_Character().init___C(12616), new $c_jl_Character().init___C(12618), new $c_jl_Character().init___C(12619), new $c_jl_Character().init___C(12620), new $c_jl_Character().init___C(12621), new $c_jl_Character().init___C(12622)]));
  var elems$2 = [];
  var i = 0;
  ...
  while ((i < len$1)) {
    var idx = i;
    var c = xs$1.u[idx];
    var elem = new $c_s_Some().init___O(new $c_jl_Character().init___C(c));
    elems$2.push(elem);
    i = ((1 + i) | 0)
  };
  var xs$2 = $makeNativeArrayWrapper($d_s_Some.getArrayOf(), elems$2);
  var elems$2$1 = [];
  var this$153 = new $c_scm_WrappedArray$ofRef().init___AO(xs$2);
  this$153.length__I();
  var xs$3 = new $c_scm_WrappedArray$ofRef().init___AO(array);
  var i$1 = 0;
  var len$2 = xs$3.length__I();
  while ((i$1 < len$2)) {
  ...
  var xs$4 = new $c_scm_WrappedArray$ofRef().init___AO(xs$2);
  var i$2 = 0;
  var len$3 = xs$4.length__I();
  while ((i$2 < len$3)) {
    var arg1$2 = xs$4.apply__I__O(i$2);
    var unboxedElem$1 = ((arg1$2 === null) ? null : arg1$2);
    elems$2$1.push(unboxedElem$1);
    i$2 = ((1 + i$2) | 0)
  };
  this.com$linterpreteur$taja$Taja$$finals$1 = $makeNativeArrayWrapper($d_s_Option.getArrayOf(), elems$2$1);
  var xs$5 = this.initials$1;
  var xs$6 = this.com$linterpreteur$taja$Taja$$finals$1;
  var pf = new $c_Lcom_linterpreteur_taja_Taja$$anonfun$1().init___();
  var elems$2$2 = [];
  var i$3 = 0;
  var len$4 = xs$6.u.length;
  while ((i$3 < len$4)) {
    var index = i$3;
    var arg1$3 = xs$6.u[index];
    var $default = $m_s_PartialFunction$().scala$PartialFunction$$fallback$undpf$f;
    var z = pf.applyOrElse__s_Option__F1__O($as_s_Option(arg1$3), $default);
    if ((!$m_s_PartialFunction$().scala$PartialFunction$$fallbackOccurred__O__Z(z))) {
      if ((z === null)) {
        var unboxedElem$2 = 0
      } else {
        var this$167 = $as_jl_Character(z);
        var unboxedElem$2 = this$167.value$1
      };
      elems$2$2.push(unboxedElem$2)
    };
    i$3 = ((1 + i$3) | 0)
  };
  var xs$7 = $makeNativeArrayWrapper($d_C.getArrayOf(), elems$2$2);
  var elems$2$3 = [];
  var this$175 = new $c_scm_WrappedArray$ofChar().init___AC(xs$7);
  this$175.length__I();
  var xs$8 = new $c_scm_WrappedArray$ofChar().init___AC(xs$5);
  var i$4 = 0;
  var len$5 = xs$8.length__I();
  while ((i$4 < len$5)) {
    var index$1 = i$4;
    var c$1 = xs$8.apply__I__C(index$1);
    elems$2$3.push(c$1);
    i$4 = ((1 + i$4) | 0)
  };
  var xs$9 = new $c_scm_WrappedArray$ofChar().init___AC(xs$7);
  var i$5 = 0;
  var len$6 = xs$9.length__I();
  while ((i$5 < len$6)) {
    var index$2 = i$5;
    var c$2 = xs$9.apply__I__C(index$2);
    elems$2$3.push(c$2);
    i$5 = ((1 + i$5) | 0)
  };
  var xs$10 = $makeNativeArrayWrapper($d_C.getArrayOf(), elems$2$3);
  var this$186 = $m_sci_Set$();
  var cbf = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$186);
  var b = cbf.apply__scm_Builder();
  b.sizeHint__I__V(xs$10.u.length);
  b.$$plus$plus$eq__sc_TraversableOnce__scg_Growable(new $c_scm_WrappedArray$ofChar().init___AC(xs$10));
  this.consonants$1 = $as_sci_Set(b.result__O());
  var xs$11 = this.middles$1;
  var this$190 = $m_sci_Set$();
  var cbf$1 = new $c_scg_GenSetFactory$$anon$1().init___scg_GenSetFactory(this$190);
  var b$1 = cbf$1.apply__scm_Builder();
  b$1.sizeHint__I__V(xs$11.u.length);
  b$1.$$plus$plus$eq__sc_TraversableOnce__scg_Growable(new $c_scm_WrappedArray$ofChar().init___AC(xs$11));
  this.vowels$1 = $as_sci_Set(b$1.result__O());
  this.first$1 = 44032;
  this.last$1 = 55203;
  var self = new $c_jl_Character().init___C(12632);
  var jsx$17 = new $c_T2().init___O__O(self, "\u3157\u314f");
  var self$1 = new $c_jl_Character().init___C(12633);
  var jsx$16 = new $c_T2().init___O__O(self$1, "\u3157\u3150");
  var self$2 = new $c_jl_Character().init___C(12634);
  var jsx$15 = new $c_T2().init___O__O(self$2, "\u3157\u3163");
  var self$3 = new $c_jl_Character().init___C(12637);
  var jsx$14 = new $c_T2().init___O__O(self$3, "\u315c\u3153");
  var self$4 = new $c_jl_Character().init___C(12638);
  var jsx$13 = new $c_T2().init___O__O(self$4, "\u315c\u3154");
  var self$5 = new $c_jl_Character().init___C(12639);
  var jsx$12 = new $c_T2().init___O__O(self$5, "\u315c\u3163");
  var self$6 = new $c_jl_Character().init___C(12642);
  var jsx$11 = new $c_T2().init___O__O(self$6, "\u3161\u3163");
  var self$7 = new $c_jl_Character().init___C(12595);
  var jsx$10 = new $c_T2().init___O__O(self$7, "\u3131\u3145");
  var self$8 = new $c_jl_Character().init___C(12597);
  var jsx$9 = new $c_T2().init___O__O(self$8, "\u3134\u3148");
  var self$9 = new $c_jl_Character().init___C(12598);
  var jsx$8 = new $c_T2().init___O__O(self$9, "\u3134\u314e");
  var self$10 = new $c_jl_Character().init___C(12602);
  var jsx$7 = new $c_T2().init___O__O(self$10, "\u3139\u3131");
  var self$11 = new $c_jl_Character().init___C(12603);
  var jsx$6 = new $c_T2().init___O__O(self$11, "\u3139\u3141");
  var self$12 = new $c_jl_Character().init___C(12604);
  var jsx$5 = new $c_T2().init___O__O(self$12, "\u3139\u3142");
  var self$13 = new $c_jl_Character().init___C(12605);
  var jsx$4 = new $c_T2().init___O__O(self$13, "\u3139\u3145");
  var self$14 = new $c_jl_Character().init___C(12606);
  var jsx$3 = new $c_T2().init___O__O(self$14, "\u3139\u314c");
  var self$15 = new $c_jl_Character().init___C(12607);
  var jsx$2 = new $c_T2().init___O__O(self$15, "\u3139\u314d");
  var self$16 = new $c_jl_Character().init___C(12608);
  var jsx$1 = new $c_T2().init___O__O(self$16, "\u3139\u314e");
  var self$17 = new $c_jl_Character().init___C(12612);
  var array$1 = [jsx$17, jsx$16, jsx$15, jsx$14, jsx$13, jsx$12, jsx$11, jsx$10, jsx$9, jsx$8, jsx$7, jsx$6, jsx$5, jsx$4, jsx$3, jsx$2, jsx$1, new $c_T2().init___O__O(self$17, "\u3142\u3145")];
  var this$266 = new $c_scm_MapBuilder().init___sc_GenMap($m_sci_Map$EmptyMap$());
  var i$6 = 0;
  var len$7 = $uI(array$1.length);
  while ((i$6 < len$7)) {
    var index$3 = i$6;
    var arg1$4 = array$1[index$3];
    this$266.$$plus$eq__T2__scm_MapBuilder($as_T2(arg1$4));
    i$6 = ((1 + i$6) | 0)
  };
  this.keystrokes$1 = $as_sci_Map(this$266.elems$1);
  var this$272 = this.keystrokes$1;
  var f = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(x0$1$2) {
    ...
    if ((x0$1 !== null)) {
      ...
      if ((c$3 === null)) {
        ...
        var this$268 = $as_jl_Character(c$3);
        var key = this$268.value$1
      };
      var value = $as_T(x0$1.$$und2$f);
      return new $c_T2().init___O__O(value, new $c_jl_Character().init___C(key))
    } else {
      throw new $c_s_MatchError().init___O(x0$1)
    }
  }));
  var this$271 = $m_sci_Map$();
  var bf = new $c_scg_GenMapFactory$MapCanBuildFrom().init___scg_GenMapFactory(this$271);
  this.combinations$1 = $as_sci_Map($s_sc_TraversableLike$class__map__sc_TraversableLike__F1__scg_CanBuildFrom__O(this$272, f, bf));
  return this
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.combinationsOf__p1__C__C__s_Option = (function(a, b) {
  return this.combinations$1.get__O__s_Option((("" + $as_T($g.String.fromCharCode(a))) + new $c_jl_Character().init___C(b)))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.isSyllable__s_Option__Z = (function($char) {
  if ($is_s_Some($char)) {
    var x2 = $as_s_Some($char);
    var c = x2.x$2;
    if ((c === null)) {
    ...
    return ((this.first$1 <= c$1) && (c$1 <= this.last$1))
  } else {
    var x = $m_s_None$();
    if ((x === $char)) {
      return false
...
$c_Lcom_linterpreteur_taja_Taja$.prototype.isConsonant__C__Z = (function($char) {
  return this.isConsonant__s_Option__Z(new $c_s_Some().init___O(new $c_jl_Character().init___C($char)))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.compose__C__C__C__T = (function(initial, middle, fin) {
  return this.compose__s_Option__s_Option__s_Option__T(new $c_s_Some().init___O(new $c_jl_Character().init___C(initial)), new $c_s_Some().init___O(new $c_jl_Character().init___C(middle)), new $c_s_Some().init___O(new $c_jl_Character().init___C(fin)))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.ungroup__sc_Traversable__sc_Traversable = (function(chars) {
  var jsx$1 = new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function($$char) {
    if (($$char === null)) {
      var $char = 0
    } else {
      var this$2 = $as_jl_Character($$char);
      var $char = this$2.value$1
    };
    return $m_Lcom_linterpreteur_taja_Taja$().decompose__C__T($char)
  }));
  var this$3 = $m_sc_Traversable$();
  return $as_sc_Traversable(chars.map__F1__scg_CanBuildFrom__O(jsx$1, this$3.ReusableCBFInstance$2))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.isHangul__s_Option__Z = (function($char) {
  return ((this.isSyllable__s_Option__Z($char) || this.isConsonant__s_Option__Z($char)) || this.isVowel__s_Option__Z($char))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.compose__C__C__T = (function(initial, middle) {
  var initial$1 = new $c_s_Some().init___O(new $c_jl_Character().init___C(initial));
  var middle$1 = new $c_s_Some().init___O(new $c_jl_Character().init___C(middle));
  return this.compose__s_Option__s_Option__s_Option__T(initial$1, middle$1, $m_s_None$())
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.isVowel__C__Z = (function($char) {
  return this.isVowel__s_Option__Z(new $c_s_Some().init___O(new $c_jl_Character().init___C($char)))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.group__p1__scm_ListBuffer__T = (function(keystrokes) {
  var this$1 = $m_scm_ListBuffer$();
  var bf = this$1.ReusableCBFInstance$2;
  var b = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(keystrokes, bf);
  var this$2 = keystrokes.scala$collection$mutable$ListBuffer$$start$6;
  var these = this$2;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    if ((arg1 === null)) {
      ...
      var this$4 = $as_jl_Character(arg1);
      var x$2 = this$4.value$1
    };
    b.$$plus$eq__O__scm_Builder(new $c_s_Some().init___O(new $c_jl_Character().init___C(x$2)));
    these = $as_sci_List(these.tail__O())
  };
  var chars = $as_scm_ListBuffer(b.result__O());
  var x = (((-1) + chars.len$6) | 0);
  var isEmpty$4 = (x > (-1));
  var isEmpty$4$1 = (x < (-1));
  var lastElement$4$1 = (isEmpty$4$1 ? ((1 + x) | 0) : (-1));
  if ((!isEmpty$4$1)) {
    var i = x;
    while (true) {
      var i$1 = i;
      var jsx$3 = $m_Lcom_linterpreteur_taja_Taja$();
      var this$16 = chars.scala$collection$mutable$ListBuffer$$start$6;
      var jsx$2 = $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$16, i$1) ? chars.apply__I__O(i$1) : $m_s_None$()));
      var x$1 = ((1 + i$1) | 0);
      var this$17 = chars.scala$collection$mutable$ListBuffer$$start$6;
      if (jsx$3.com$linterpreteur$taja$Taja$$combinationsOf__s_Option__s_Option__s_Option(jsx$2, $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$17, x$1) ? chars.apply__I__O(x$1) : $m_s_None$()))).isEmpty__Z()) {
        var jsx$5 = $m_Lcom_linterpreteur_taja_Taja$();
        var x$3 = ((1 + i$1) | 0);
        var this$18 = chars.scala$collection$mutable$ListBuffer$$start$6;
        var jsx$4 = $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$18, x$3) ? chars.apply__I__O(x$3) : $m_s_None$()));
        var x$4 = ((2 + i$1) | 0);
        var this$19 = chars.scala$collection$mutable$ListBuffer$$start$6;
        var jsx$1 = jsx$5.com$linterpreteur$taja$Taja$$combinationsOf__s_Option__s_Option__s_Option(jsx$4, $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$19, x$4) ? chars.apply__I__O(x$4) : $m_s_None$()))).isDefined__Z()
      } else {
        var jsx$1 = false
      };
      if (jsx$1) {
        var this$22 = $m_Lcom_linterpreteur_taja_Taja$();
        var x$5 = ((1 + i$1) | 0);
        var this$20 = chars.scala$collection$mutable$ListBuffer$$start$6;
        var jsx$6 = $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$20, x$5) ? chars.apply__I__O(x$5) : $m_s_None$()));
        var x$6 = ((2 + i$1) | 0);
        var this$21 = chars.scala$collection$mutable$ListBuffer$$start$6;
        var array = [jsx$6, $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$21, x$6) ? chars.apply__I__O(x$6) : $m_s_None$()))];
        var pf = new $c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1().init___();
        $m_sc_Seq$();
        ...
        while ((i$2 < len)) {
          ...
          var $default = $m_s_PartialFunction$().scala$PartialFunction$$fallback$undpf$f;
          var z = pf.applyOrElse__s_Option__F1__O($as_s_Option(arg1$1), $default);
          if ((!$m_s_PartialFunction$().scala$PartialFunction$$fallbackOccurred__O__Z(z))) {
            b$1.array$6.push(z)
          };
          i$2 = ((1 + i$2) | 0)
        };
        var merged = this$22.merge__p1__sc_Seq__T(b$1);
        chars.remove__I__I__V(((1 + i$1) | 0), 2);
        var this$27 = new $c_sci_StringOps().init___T(merged);
        var this$26 = $m_s_Predef$();
        var bf$2 = new $c_s_LowPriorityImplicits$$anon$4().init___s_LowPriorityImplicits(this$26);
        var b$2 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$27, bf$2);
        var i$3 = 0;
        var $$this = this$27.repr$1;
        var len$1 = $uI($$this.length);
        while ((i$3 < len$1)) {
          var arg1$2 = this$27.apply__I__O(i$3);
          if ((arg1$2 === null)) {
            var x$6$1 = 0
          } else {
            var this$31 = $as_jl_Character(arg1$2);
            var x$6$1 = this$31.value$1
          };
          b$2.$$plus$eq__O__scm_Builder(new $c_s_Some().init___O(new $c_jl_Character().init___C(x$6$1)));
          i$3 = ((1 + i$3) | 0)
        };
        chars.insertAll__I__sc_Traversable__V(((1 + i$1) | 0), $as_sc_Traversable(b$2.result__O()))
      };
      var jsx$8 = $m_Lcom_linterpreteur_taja_Taja$();
      var this$34 = chars.scala$collection$mutable$ListBuffer$$start$6;
      if (jsx$8.isConsonant__s_Option__Z($as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$34, i$1) ? chars.apply__I__O(i$1) : $m_s_None$())))) {
        var jsx$9 = $m_Lcom_linterpreteur_taja_Taja$();
        var x$7 = ((1 + i$1) | 0);
        var this$35 = chars.scala$collection$mutable$ListBuffer$$start$6;
        var jsx$7 = jsx$9.isVowel__s_Option__Z($as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$35, x$7) ? chars.apply__I__O(x$7) : $m_s_None$())))
      } else {
        var jsx$7 = false
      };
      if (jsx$7) {
        var jsx$11 = $m_Lcom_linterpreteur_taja_Taja$();
        var x$8 = ((2 + i$1) | 0);
        var this$36 = chars.scala$collection$mutable$ListBuffer$$start$6;
        if (jsx$11.isConsonant__s_Option__Z($as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$36, x$8) ? chars.apply__I__O(x$8) : $m_s_None$())))) {
          var xs = $m_Lcom_linterpreteur_taja_Taja$().com$linterpreteur$taja$Taja$$finals$1;
          var x$9 = ((2 + i$1) | 0);
          var this$38 = chars.scala$collection$mutable$ListBuffer$$start$6;
          var elem = $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$38, x$9) ? chars.apply__I__O(x$9) : $m_s_None$()));
          var i$4 = 0;
          while (true) {
            if ((i$4 < xs.u.length)) {
              var index$1 = i$4;
              var arg1$3 = xs.u[index$1];
              var jsx$12 = ($m_sr_BoxesRunTime$().equals__O__O__Z(arg1$3, elem) === false)
            } else {
              var jsx$12 = false
            };
            if (jsx$12) {
          ...
          var jsx$10 = (i$4 !== xs.u.length)
        } else {
          var jsx$10 = false
        };
        if (jsx$10) {
          var jsx$15 = $m_Lcom_linterpreteur_taja_Taja$();
          var this$42 = chars.scala$collection$mutable$ListBuffer$$start$6;
          var jsx$14 = $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$42, i$1) ? chars.apply__I__O(i$1) : $m_s_None$()));
          var x$10 = ((1 + i$1) | 0);
          var this$43 = chars.scala$collection$mutable$ListBuffer$$start$6;
          var jsx$13 = $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$43, x$10) ? chars.apply__I__O(x$10) : $m_s_None$()));
          var x$11 = ((2 + i$1) | 0);
          var this$44 = chars.scala$collection$mutable$ListBuffer$$start$6;
          var composed = jsx$15.compose__s_Option__s_Option__s_Option__T(jsx$14, jsx$13, $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$44, x$11) ? chars.apply__I__O(x$11) : $m_s_None$())));
          chars.remove__I__I__V(i$1, 3);
          var this$47 = new $c_sci_StringOps().init___T(composed);
          var this$46 = $m_s_Predef$();
          var bf$3 = new $c_s_LowPriorityImplicits$$anon$4().init___s_LowPriorityImplicits(this$46);
          var b$3 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$47, bf$3);
          var i$5 = 0;
          var $$this$1 = this$47.repr$1;
          var len$2 = $uI($$this$1.length);
          while ((i$5 < len$2)) {
            var arg1$4 = this$47.apply__I__O(i$5);
            if ((arg1$4 === null)) {
              var x$7$1 = 0
            } else {
              var this$51 = $as_jl_Character(arg1$4);
              var x$7$1 = this$51.value$1
            };
            b$3.$$plus$eq__O__scm_Builder(new $c_s_Some().init___O(new $c_jl_Character().init___C(x$7$1)));
            i$5 = ((1 + i$5) | 0)
          };
          chars.insertAll__I__sc_Traversable__V(i$1, $as_sc_Traversable(b$3.result__O()))
        } else {
          var this$56 = $m_Lcom_linterpreteur_taja_Taja$();
          var this$54 = chars.scala$collection$mutable$ListBuffer$$start$6;
          var initial = $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$54, i$1) ? chars.apply__I__O(i$1) : $m_s_None$()));
          var x$12 = ((1 + i$1) | 0);
          var this$55 = chars.scala$collection$mutable$ListBuffer$$start$6;
          var middle = $as_s_Option(($s_sc_LinearSeqOptimized$class__isDefinedAt__sc_LinearSeqOptimized__I__Z(this$55, x$12) ? chars.apply__I__O(x$12) : $m_s_None$()));
          var composed$2 = this$56.compose__s_Option__s_Option__s_Option__T(initial, middle, $m_s_None$());
          chars.remove__I__I__V(i$1, 2);
          var this$59 = new $c_sci_StringOps().init___T(composed$2);
          var this$58 = $m_s_Predef$();
          var bf$4 = new $c_s_LowPriorityImplicits$$anon$4().init___s_LowPriorityImplicits(this$58);
          var b$4 = $s_sc_TraversableLike$class__builder$1__p0__sc_TraversableLike__scg_CanBuildFrom__scm_Builder(this$59, bf$4);
          var i$6 = 0;
          var $$this$2 = this$59.repr$1;
          var len$3 = $uI($$this$2.length);
          while ((i$6 < len$3)) {
            var arg1$5 = this$59.apply__I__O(i$6);
            if ((arg1$5 === null)) {
              var x$8$1 = 0
            } else {
              var this$63 = $as_jl_Character(arg1$5);
              var x$8$1 = this$63.value$1
            };
            b$4.$$plus$eq__O__scm_Builder(new $c_s_Some().init___O(new $c_jl_Character().init___C(x$8$1)));
            i$6 = ((1 + i$6) | 0)
          };
          chars.insertAll__I__sc_Traversable__V(i$1, $as_sc_Traversable(b$4.result__O()))
        }
      };
      if ((i === lastElement$4$1)) {
        break
      };
      i = (((-1) + i) | 0)
    }
  };
  var pf$1 = new $c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2().init___();
  var this$66 = $m_scm_ListBuffer$();
  var bf$5 = this$66.ReusableCBFInstance$2;
  var this$67 = $as_scg_TraversableForwarder($s_sc_TraversableLike$class__collect__sc_TraversableLike__s_PartialFunction__scg_CanBuildFrom__O(chars, pf$1, bf$5));
  var this$68 = this$67.scala$collection$mutable$ListBuffer$$start$6;
  return $s_sc_TraversableOnce$class__mkString__sc_TraversableOnce__T__T__T__T(this$68, "", "", "")
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.isConsonant__s_Option__Z = (function($char) {
  if ($is_s_Some($char)) {
    var x2 = $as_s_Some($char);
    var c = x2.x$2;
    if ((c === null)) {
    ...
    return this.consonants$1.contains__O__Z(new $c_jl_Character().init___C(c$1))
  } else {
    var x = $m_s_None$();
    if ((x === $char)) {
      return false
...
$c_Lcom_linterpreteur_taja_Taja$.prototype.isSyllable__C__Z = (function($char) {
  return this.isSyllable__s_Option__Z(new $c_s_Some().init___O(new $c_jl_Character().init___C($char)))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.decompose__C__T = (function($char) {
  if (this.isSyllable__s_Option__Z(new $c_s_Some().init___O(new $c_jl_Character().init___C($char)))) {
    var code = (($char - this.first$1) | 0);
    var initial = ((code / $imul(this.com$linterpreteur$taja$Taja$$finals$1.u.length, this.middles$1.u.length)) | 0);
    var middle = ((((code % $imul(this.com$linterpreteur$taja$Taja$$finals$1.u.length, this.middles$1.u.length)) | 0) / this.com$linterpreteur$taja$Taja$$finals$1.u.length) | 0);
    var fin = ((code % this.com$linterpreteur$taja$Taja$$finals$1.u.length) | 0);
    return ((("" + this.unmerge__p1__C__T(this.initials$1.u[initial])) + this.unmerge__p1__C__T(this.middles$1.u[middle])) + this.unmerge__p1__s_Option__T(this.com$linterpreteur$taja$Taja$$finals$1.u[fin]))
  } else {
    return this.unmerge__p1__C__T($char)
  }
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.compose__s_Option__s_Option__s_Option__T = (function(initial, middle, fin) {
  if ((initial.isEmpty__Z() || middle.isEmpty__Z())) {
    return ((("" + $objectToString((initial.isEmpty__Z() ? "" : initial.get__O()))) + (middle.isEmpty__Z() ? "" : middle.get__O())) + (fin.isEmpty__Z() ? "" : fin.get__O()))
  };
  var xs = this.initials$1;
  var elem = initial.get__O();
  var len = xs.u.length;
  var i = 0;
  while (true) {
    if ((i < len)) {
      ...
      var jsx$1 = (!$m_sr_BoxesRunTime$().equals__O__O__Z(elem, arg1))
    } else {
      var jsx$1 = false
    };
    if (jsx$1) {
  ...
  var n = i;
  var initialIndex = ((n >= xs.u.length) ? (-1) : n);
  var xs$1 = this.middles$1;
  var elem$1 = middle.get__O();
  var len$1 = xs$1.u.length;
  var i$1 = 0;
  while (true) {
    if ((i$1 < len$1)) {
      var idx$1 = i$1;
      var c$1 = xs$1.u[idx$1];
      var arg1$1 = new $c_jl_Character().init___C(c$1);
      var jsx$2 = (!$m_sr_BoxesRunTime$().equals__O__O__Z(elem$1, arg1$1))
    } else {
      var jsx$2 = false
    };
    if (jsx$2) {
  ...
  var n$1 = i$1;
  var middleIndex = ((n$1 >= xs$1.u.length) ? (-1) : n$1);
  var xs$2 = this.com$linterpreteur$taja$Taja$$finals$1;
  ...
  while (true) {
    if ((i$2 < len$2)) {
      ...
      var jsx$3 = (!$m_sr_BoxesRunTime$().equals__O__O__Z(fin, arg1$2))
    } else {
      var jsx$3 = false
    };
    if (jsx$3) {
  ...
  var n$2 = i$2;
  var finalIndex = ((n$2 >= xs$2.u.length) ? (-1) : n$2);
  if ((((initialIndex === (-1)) || (middleIndex === (-1))) || (finalIndex === (-1)))) {
    return ((("" + $objectToString(initial.get__O())) + middle.get__O()) + (fin.isEmpty__Z() ? "" : fin.get__O()))
  };
  var a = $imul($imul(this.com$linterpreteur$taja$Taja$$finals$1.u.length, this.middles$1.u.length), initialIndex);
  var b = $imul(this.com$linterpreteur$taja$Taja$$finals$1.u.length, middleIndex);
  var c$2 = (65535 & ((((((this.first$1 + a) | 0) + b) | 0) + finalIndex) | 0));
  return $as_T($g.String.fromCharCode(c$2))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.isHangul__C__Z = (function($char) {
  return this.isHangul__s_Option__Z(new $c_s_Some().init___O(new $c_jl_Character().init___C($char)))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.group__sc_Traversable__T = (function(keystrokes) {
  var this$1 = $m_scm_ListBuffer$();
  var cbf = this$1.ReusableCBFInstance$2;
  return this.group__p1__scm_ListBuffer__T($as_scm_ListBuffer($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(keystrokes, cbf)))
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.unmerge__p1__s_Option__T = (function($char) {
  if ($is_s_Some($char)) {
    var x2 = $as_s_Some($char);
    var c = x2.x$2;
    if ((c === null)) {
      ...
      var this$2 = $as_jl_Character(c);
      var x = this$2.value$1
    };
    return this.unmerge__p1__C__T(x)
  } else {
    var x$2 = $m_s_None$();
    if ((x$2 === $char)) {
      return ""
...
$c_Lcom_linterpreteur_taja_Taja$.prototype.unmerge__p1__C__T = (function($char) {
  var this$3 = this.keystrokes$1;
  var key = new $c_jl_Character().init___C($char);
  var x1 = this$3.get__O__s_Option(key);
  if ($is_s_Some(x1)) {
    var x2 = $as_s_Some(x1);
    var v = x2.x$2;
    var jsx$1 = v
    ...
    var jsx$1 = new $c_jl_Character().init___C($char)
  };
  return $objectToString(jsx$1)
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.com$linterpreteur$taja$Taja$$combinationsOf__s_Option__s_Option__s_Option = (function(a, b) {
  var x1 = new $c_T2().init___O__O(a, b);
  ...
  var p6 = $as_s_Option(x1.$$und1$f);
  var p7 = $as_s_Option(x1.$$und2$f);
  if ($is_s_Some(p6)) {
    var x8 = $as_s_Some(p6);
    var c = x8.x$2;
    if ((c === null)) {
    ...
    if ($is_s_Some(p7)) {
      ...
      if ((c$1 === null)) {
        ...
        var this$4 = $as_jl_Character(c$1);
        var y = this$4.value$1
      };
      return this.combinationsOf__p1__C__C__s_Option(x$5, y)
    }
  };
  throw new $c_s_MatchError().init___O(x1)
});
var $d_Lcom_linterpreteur_taja_Taja$ = new $TypeData().initClass({
  Lcom_linterpreteur_taja_Taja$: 0
}, false, "com.linterpreteur.taja.Taja$", {
  Lcom_linterpreteur_taja_Taja$: 1,
  O: 1
});
$c_Lcom_linterpreteur_taja_Taja$.prototype.$classData = $d_Lcom_linterpreteur_taja_Taja$;
var $n_Lcom_linterpreteur_taja_Taja$ = (void 0);
function $m_Lcom_linterpreteur_taja_Taja$() {
  if ((!$n_Lcom_linterpreteur_taja_Taja$)) {
    $n_Lcom_linterpreteur_taja_Taja$ = new $c_Lcom_linterpreteur_taja_Taja$().init___()
  };
  return $n_Lcom_linterpreteur_taja_Taja$
}
/** @constructor */
function $c_Lcom_linterpreteur_taja_TajaJS$() {
  $c_O.call(this)
}
$c_Lcom_linterpreteur_taja_TajaJS$.prototype = new $h_O();
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.constructor = $c_Lcom_linterpreteur_taja_TajaJS$;
/** @constructor */
function $h_Lcom_linterpreteur_taja_TajaJS$() {
  /*<skip>*/
}
$h_Lcom_linterpreteur_taja_TajaJS$.prototype = $c_Lcom_linterpreteur_taja_TajaJS$.prototype;
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.init___ = (function() {
  return this
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.ungroup__T__sjs_js_Array = (function(string) {
  var col = $m_Lcom_linterpreteur_taja_Taja$().ungroup__sc_Traversable__sc_Traversable($m_s_Predef$().wrapString__T__sci_WrappedString(string));
...
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$isHangul__T__O = (function($char) {
  return this.isHangul__T__Z($char)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$isSyllable__T__O = (function($char) {
  return this.isSyllable__T__Z($char)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$decompose__T__O = (function($char) {
  return this.decompose__T__T($char)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$ungroup__T__O = (function(string) {
  return this.ungroup__T__sjs_js_Array(string)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$isConsonant__T__O = (function($char) {
  return this.isConsonant__T__Z($char)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$isVowel__T__O = (function($char) {
  return this.isVowel__T__Z($char)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$group__sjs_js_Array__O = (function(string) {
  return this.group__sjs_js_Array__T(string)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.compose__T__T__T = (function(initial, middle) {
  return $m_Lcom_linterpreteur_taja_Taja$().compose__C__C__T((65535 & $uI(initial.charCodeAt(0))), (65535 & $uI(middle.charCodeAt(0))))
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.group__sjs_js_Array__T = (function(string) {
  var jsx$1 = $m_Lcom_linterpreteur_taja_Taja$();
  var array = [];
  $uI(string.length);
  var i = 0;
  var len = $uI(string.length);
  while ((i < len)) {
    var index = i;
    var arg1 = string[index];
    var str = $as_T(arg1);
    var c = (65535 & $uI(str.charCodeAt(0)));
    var elem = new $c_jl_Character().init___C(c);
    array.push(elem);
    i = ((1 + i) | 0)
  };
  return jsx$1.group__sc_Traversable__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array(array))
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.isConsonant__T__Z = (function($char) {
  return $m_Lcom_linterpreteur_taja_Taja$().isConsonant__C__Z((65535 & $uI($char.charCodeAt(0))))
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$compose__T__T__T__O = (function(initial, middle, fin) {
  return this.compose__T__T__T__T(initial, middle, fin)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.isVowel__T__Z = (function($char) {
  return $m_Lcom_linterpreteur_taja_Taja$().isVowel__C__Z((65535 & $uI($char.charCodeAt(0))))
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.compose__T__T__T__T = (function(initial, middle, fin) {
  return $m_Lcom_linterpreteur_taja_Taja$().compose__C__C__C__T((65535 & $uI(initial.charCodeAt(0))), (65535 & $uI(middle.charCodeAt(0))), (65535 & $uI(fin.charCodeAt(0))))
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.isSyllable__T__Z = (function($char) {
  return $m_Lcom_linterpreteur_taja_Taja$().isSyllable__C__Z((65535 & $uI($char.charCodeAt(0))))
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$$js$exported$meth$compose__T__T__O = (function(initial, middle) {
  return this.compose__T__T__T(initial, middle)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.isHangul__T__Z = (function($char) {
  return $m_Lcom_linterpreteur_taja_Taja$().isHangul__C__Z((65535 & $uI($char.charCodeAt(0))))
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.decompose__T__T = (function($char) {
  return $m_Lcom_linterpreteur_taja_Taja$().decompose__C__T((65535 & $uI($char.charCodeAt(0))))
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.isVowel = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return this.$$js$exported$meth$isVowel__T__O(prep0)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.isConsonant = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return this.$$js$exported$meth$isConsonant__T__O(prep0)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.isSyllable = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return this.$$js$exported$meth$isSyllable__T__O(prep0)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.isHangul = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return this.$$js$exported$meth$isHangul__T__O(prep0)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.ungroup = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return this.$$js$exported$meth$ungroup__T__O(prep0)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.group = (function(arg$1) {
  var prep0 = arg$1;
  return this.$$js$exported$meth$group__sjs_js_Array__O(prep0)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.decompose = (function(arg$1) {
  var prep0 = $as_T(arg$1);
  return this.$$js$exported$meth$decompose__T__O(prep0)
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.compose = (function(arg$1, arg$2) {
...
var $d_Lcom_linterpreteur_taja_TajaJS$ = new $TypeData().initClass({
  Lcom_linterpreteur_taja_TajaJS$: 0
}, false, "com.linterpreteur.taja.TajaJS$", {
  Lcom_linterpreteur_taja_TajaJS$: 1,
  O: 1
});
$c_Lcom_linterpreteur_taja_TajaJS$.prototype.$classData = $d_Lcom_linterpreteur_taja_TajaJS$;
var $n_Lcom_linterpreteur_taja_TajaJS$ = (void 0);
function $m_Lcom_linterpreteur_taja_TajaJS$() {
  if ((!$n_Lcom_linterpreteur_taja_TajaJS$)) {
    $n_Lcom_linterpreteur_taja_TajaJS$ = new $c_Lcom_linterpreteur_taja_TajaJS$().init___()
  };
  return $n_Lcom_linterpreteur_taja_TajaJS$
}
$e.taja = $m_Lcom_linterpreteur_taja_TajaJS$;
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
  this.data$1 = null
...
$c_sr_AbstractPartialFunction.prototype.runWith__F1__F1 = (function(action) {
  return $s_s_PartialFunction$class__runWith__s_PartialFunction__F1__F1(this, action)
});
...
$c_s_Array$.prototype.apply__C__sc_Seq__AC = (function(x, xs) {
  var array = $newArrayObject($d_C.getArrayOf(), [((1 + xs.length__I()) | 0)]);
  array.u[0] = x;
  var elem$1 = 0;
  elem$1 = 1;
...
/** @constructor */
function $c_Lcom_linterpreteur_taja_Taja$$anonfun$1() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype.constructor = $c_Lcom_linterpreteur_taja_Taja$$anonfun$1;
/** @constructor */
function $h_Lcom_linterpreteur_taja_Taja$$anonfun$1() {
  /*<skip>*/
}
$h_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype = $c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype;
$c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype.init___ = (function() {
  return this
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype.applyOrElse__s_Option__F1__O = (function(x1, $default) {
  if ($is_s_Some(x1)) {
    var x2 = $as_s_Some(x1);
    var c = x2.x$2;
    if ((c === null)) {
    ...
    return new $c_jl_Character().init___C(c$1)
  } else {
    return $default.apply__O__O(x1)
  }
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__s_Option__Z($as_s_Option(x))
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__s_Option__F1__O($as_s_Option(x), $default)
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype.isDefinedAt__s_Option__Z = (function(x1) {
  return $is_s_Some(x1)
});
var $d_Lcom_linterpreteur_taja_Taja$$anonfun$1 = new $TypeData().initClass({
  Lcom_linterpreteur_taja_Taja$$anonfun$1: 0
}, false, "com.linterpreteur.taja.Taja$$anonfun$1", {
  Lcom_linterpreteur_taja_Taja$$anonfun$1: 1,
...
$c_Lcom_linterpreteur_taja_Taja$$anonfun$1.prototype.$classData = $d_Lcom_linterpreteur_taja_Taja$$anonfun$1;
/** @constructor */
function $c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype = new $h_sr_AbstractPartialFunction();
$c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype.constructor = $c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1;
/** @constructor */
function $h_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1() {
  /*<skip>*/
}
$h_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype = $c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype;
$c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype.init___ = (function() {
  return this
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype.applyOrElse__s_Option__F1__O = (function(x2, $default) {
  if ($is_s_Some(x2)) {
    ...
    return new $c_jl_Character().init___C(x)
  } else {
    return $default.apply__O__O(x2)
  }
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__s_Option__Z($as_s_Option(x))
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__s_Option__F1__O($as_s_Option(x), $default)
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype.isDefinedAt__s_Option__Z = (function(x2) {
  return $is_s_Some(x2)
});
var $d_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1 = new $TypeData().initClass({
  Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1: 0
}, false, "com.linterpreteur.taja.Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1", {
  Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1.prototype.$classData = $d_Lcom_linterpreteur_taja_Taja$$anonfun$com$linterpreteur$taja$Taja$$merge$1;
/** @constructor */
function $c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2() {
  $c_sr_AbstractPartialFunction.call(this)
}
$c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype = new $h_sr_AbstractPartialFunction();
$c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype.constructor = $c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2;
/** @constructor */
function $h_Lcom_linterpreteur_taja_Taja$$anonfun$group$2() {
  /*<skip>*/
}
$h_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype = $c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype;
$c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype.init___ = (function() {
  return this
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype.isDefinedAt__s_Some__Z = (function(x3) {
  return (x3 !== null)
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype.isDefinedAt__O__Z = (function(x) {
  return this.isDefinedAt__s_Some__Z($as_s_Some(x))
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype.applyOrElse__O__F1__O = (function(x, $default) {
  return this.applyOrElse__s_Some__F1__O($as_s_Some(x), $default)
});
$c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype.applyOrElse__s_Some__F1__O = (function(x3, $default) {
  if ((x3 !== null)) {
    var c = x3.x$2;
    if ((c === null)) {
      var x = 0
...
var $d_Lcom_linterpreteur_taja_Taja$$anonfun$group$2 = new $TypeData().initClass({
  Lcom_linterpreteur_taja_Taja$$anonfun$group$2: 0
}, false, "com.linterpreteur.taja.Taja$$anonfun$group$2", {
  Lcom_linterpreteur_taja_Taja$$anonfun$group$2: 1,
  sr_AbstractPartialFunction: 1,
  O: 1,
  F1: 1,
  s_PartialFunction: 1,
...
$c_Lcom_linterpreteur_taja_Taja$$anonfun$group$2.prototype.$classData = $d_Lcom_linterpreteur_taja_Taja$$anonfun$group$2;
/** @constructor */
function $c_T2() {
  $c_O.call(this);
  this.$$und1$f = null;
...
function $is_scg_TraversableForwarder(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.scg_TraversableForwarder)))
}
function $as_scg_TraversableForwarder(obj) {
  return (($is_scg_TraversableForwarder(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "scala.collection.generic.TraversableForwarder"))
}
function $isArrayOf_scg_TraversableForwarder(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.scg_TraversableForwarder)))
}
function $asArrayOf_scg_TraversableForwarder(obj, depth) {
  return (($isArrayOf_scg_TraversableForwarder(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lscala.collection.generic.TraversableForwarder;", depth))
}
/** @constructor */
...
$c_scm_ListBuffer.prototype.remove__I__I__V = (function(n, count) {
  ...
  if ((count < 0)) {
    throw new $c_jl_IllegalArgumentException().init___T(new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["removing negative number (", ") of elements"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([count])))
  };
  if (this.exported$6) {
    this.copy__p6__V()
  };
  var n1 = ((n > 0) ? n : 0);
  var that = ((this.len$6 - n1) | 0);
  var count1 = ((count < that) ? count : that);
  if ((n1 === 0)) {
    var c = count1;
    while ((c > 0)) {
...
$c_scm_ListBuffer.prototype.mkString__T = (function() {
  var this$1 = this.scala$collection$mutable$ListBuffer$$start$6;
  return $s_sc_TraversableOnce$class__mkString__sc_TraversableOnce__T__T__T__T(this$1, "", "", "")
});
...
$c_scm_ListBuffer.prototype.insertAll__I__sc_Traversable__V = (function(n, seq) {
  ...
  var this$2 = elems;
  this.len$6 = ((jsx$1 + $s_sc_LinearSeqOptimized$class__length__sc_LinearSeqOptimized__I(this$2)) | 0);
  if ((n === 0)) {
    while ((!elems.isEmpty__Z())) {
...
//# sourceMappingURL=taja-fastopt.js.map
